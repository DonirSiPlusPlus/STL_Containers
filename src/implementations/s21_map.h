#ifndef SRC_IMPLEMENTATIONS_MAP_S21_MAP_H
#define SRC_IMPLEMENTATIONS_MAP_S21_MAP_H
...
class map {
 public:
  ...
  T &at(const Key &key) {
    ...
    throw std::invalid_argument("\"s21_map::at\" thrown in the test body.");
  }
...
#endif  // SRC_IMPLEMENTATIONS_MAP_S21_MAP_H
